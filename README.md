# 非公式 和歌山県 新型コロナウイルス感染症対策サイト

![](https://github.com/tokyo-metropolitan-gov/covid19/workflows/production%20deploy/badge.svg)

[![和歌山県 新型コロナウイルス感染症対策サイト](./static/ogp.png)](https://stopcovid19.metro.tokyo.lg.jp/)
...
| 目的 | ブランチ | 確認URL | 備考 |
| ---- | -------- | ---- | ---- |
| 本番サイトHTML | production | https://hardcore-galileo-f8a534.netlify.com | 静的ビルドされたHTMLが置いてある場所 |
